...
const I18N={
 ...
 eyebrow:{de:'Baustein 6 · Akademie-PDF-Zentrale',en:'Module 6 · Academy PDF centre'},heroTitle:{de:'Erst Datenstand freigeben. Dann genau daraus die PDF erzeugen.',en:'Release the data state first. Then create the PDF from exactly that state.'},heroCopy:{de:'Prüffassung, bewusste Freigabe und PDF-Ausgabe sind getrennte Schritte. Eine fertige PDF wird nur vorübergehend im geöffneten Browser gehalten und unverändert an Speichern oder Teilen übergeben.',en:'Review version, deliberate release and PDF output are separate steps. A finished PDF is held only temporarily in the open browser and is passed unchanged to save or share.'},
 archive:{de:'Archiv öffnen',en:'Open archive'},settings:{de:'Sicherung & Jahreswechsel',en:'Backup & year change'},showLast:{de:'Letzte fertige PDF erneut anzeigen',en:'Show last finished PDF again'},master:{de:'PDF-Master',en:'PDF master'},masterTitle:{de:'Hotel-Master-Technik integriert',en:'Hotel master technology integrated'},masterCopy:{de:'A4-PDF lokal, kein Druckdialog, kein externer PDF-Dienst.',en:'Local A4 PDF, no print dialog, no external PDF service.'},status:{de:'Status',en:'Status'},snapshot:{de:'Snapshot-basiert',en:'Snapshot based'},
 ...
 serviceSource:{de:'Mietservice',en:'Tenant service'},serviceTitle:{de:'Gespeicherte Entwürfe übernehmen',en:'Use saved drafts'},serviceCopy:{de:'Der Baustein-5-Entwurf bleibt unverändert; die PDF-Zentrale erzeugt daraus eine eigene Prüffassung.',en:'The Module 5 draft remains unchanged; the PDF centre creates a separate review version from it.'},
 ...
 releaseButton:{de:'Datenstand freigeben',en:'Release data state'},deleteReview:{de:'Prüffassung löschen',en:'Delete review version'},createPdf:{de:'PDF erstellen',en:'Create PDF'},servicePrepare:{de:'Als Prüffassung übernehmen',en:'Create review version'},legalFlag:{de:'Fach-/Rechtsprüfung vor Verwendung beachten.',en:'Professional/legal review should be considered before use.'}
};
initI18n(I18N);

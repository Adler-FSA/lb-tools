...
export const DEMO_VERSION='LINDENBLICK_V1_2026-09-24';
...
function addCoreData(p){
  ...
  p.units.push(
    {id:'demo_owner_unit',propertyId:'demo_house',label:'Erdgeschoss · Eigennutzung',floor:'EG',
      areaHistory:[{from:'2025-01-01',to:null,hundredthsM2:9500}]},
    {id:'demo_rent_a',propertyId:'demo_house',label:'1. OG links · Wohnung A',floor:'1. OG links',
      areaHistory:[{from:'2025-01-01',to:null,hundredthsM2:7500}]},
    {id:'demo_rent_b',propertyId:'demo_house',label:'1. OG rechts · Wohnung B',floor:'1. OG rechts',
      areaHistory:[{from:'2025-01-01',to:null,hundredthsM2:6500}]}
  );
  p.tenancies.push(
    {id:'demo_lease_berger',unitId:'demo_rent_a',partyLabel:'Familie Berger · fiktiv',startDate:'2025-01-01',endDate:null},
    {id:'demo_lease_schneider',unitId:'demo_rent_b',partyLabel:'Jonas Schneider · fiktiv',startDate:'2025-01-01',endDate:'2026-06-30'},
    {id:'demo_lease_vogel',unitId:'demo_rent_b',partyLabel:'Nina Vogel · fiktiv',startDate:'2026-07-01',endDate:null}
  );
  p.usagePeriods.push(
    {id:'demo_use_owner',unitId:'demo_owner_unit',kind:'owner',startDate:'2025-01-01',endDate:null},
    {id:'demo_use_berger',unitId:'demo_rent_a',kind:'tenant',tenancyId:'demo_lease_berger',startDate:'2025-01-01',endDate:null},
    {id:'demo_use_schneider',unitId:'demo_rent_b',kind:'tenant',tenancyId:'demo_lease_schneider',startDate:'2025-01-01',endDate:'2026-06-30'},
    {id:'demo_use_vogel',unitId:'demo_rent_b',kind:'tenant',tenancyId:'demo_lease_vogel',startDate:'2026-07-01',endDate:null}
  );
  p.contractTerms.push(
    {id:'demo_terms_berger',tenancyId:'demo_lease_berger',startDate:'2025-01-01',endDate:null,
      operatingCostsModel:'advance',advanceCents:22000,allowedCostTypes:[...standardCosts]},
    {id:'demo_terms_schneider',tenancyId:'demo_lease_schneider',startDate:'2025-01-01',endDate:'2026-06-30',
      operatingCostsModel:'advance',advanceCents:18000,allowedCostTypes:[...standardCosts]},
    {id:'demo_terms_vogel',tenancyId:'demo_lease_vogel',startDate:'2026-07-01',endDate:null,
  ...
  p.accountingPeriods.push(
    ...
    {id:'demo_year_2026',propertyId:'demo_house',startDate:'2026-01-01',endDate:'2026-12-31',
...
function addMeters(p){
  p.meters.push(
    {id:'demo_water_owner',propertyId:'demo_house',unitId:'demo_owner_unit',service:'cold_water',measurementUnit:'m³',installedAt:'2024-01-01',label:'Kaltwasser EG'},
    {id:'demo_water_a',propertyId:'demo_house',unitId:'demo_rent_a',service:'cold_water',measurementUnit:'m³',installedAt:'2024-01-01',label:'Kaltwasser Wohnung A'},
    {id:'demo_water_b',propertyId:'demo_house',unitId:'demo_rent_b',service:'cold_water',measurementUnit:'m³',installedAt:'2024-01-01',label:'Kaltwasser Wohnung B'}
  );
  p.readings.push(
    {id:'demo_read_owner_2501',meterId:'demo_water_owner',date:'2025-01-01',value:100},
    {id:'demo_read_owner_2512',meterId:'demo_water_owner',date:'2025-12-31',value:160},
    {id:'demo_read_owner_2601',meterId:'demo_water_owner',date:'2026-01-01',value:161},
    {id:'demo_read_owner_2612',meterId:'demo_water_owner',date:'2026-12-31',value:225},

    {id:'demo_read_a_2501',meterId:'demo_water_a',date:'2025-01-01',value:50},
    {id:'demo_read_a_2512',meterId:'demo_water_a',date:'2025-12-31',value:95},
    {id:'demo_read_a_2601',meterId:'demo_water_a',date:'2026-01-01',value:96},
    {id:'demo_read_a_2612',meterId:'demo_water_a',date:'2026-12-31',value:145},

    {id:'demo_read_b_2501',meterId:'demo_water_b',date:'2025-01-01',value:20},
    {id:'demo_read_b_2512',meterId:'demo_water_b',date:'2025-12-31',value:60},
    {id:'demo_read_b_2601',meterId:'demo_water_b',date:'2026-01-01',value:61},
    {id:'demo_read_b_2607',meterId:'demo_water_b',date:'2026-07-01',value:85},
    {id:'demo_read_b_2612',meterId:'demo_water_b',date:'2026-12-31',value:115}
  );
}

function addYear2025(p){
  const costs=[
    ['demo_tax_2025','property_tax',240000,'demo_city'],
    ['demo_insurance_2025','building_insurance',120000,'demo_insurer'],
    ['demo_waste_2025','waste',72000,'demo_waste_provider'],
    ['demo_power_2025','common_electricity',48000,'demo_power_provider'],
    ['demo_water_2025','cold_water',90000,'demo_water_provider']
  ];
  for(const [id,category,amountCents,providerAccountId] of costs){
    ...
    if(category==='cold_water') addWaterRule(p,{id:`rule_${id}`,expenseId:id,periodId:'demo_year_2025'});
    else addAreaRule(p,{id:`rule_${id}`,expenseId:id,periodId:'demo_year_2025'});
    addProviderPayment(p,{id:`pay_${id}`,year:2025,providerAccountId,amountCents,date:'2025-12-20'});
  }
  addExpense(p,{id:'demo_repair_2025',year:2025,category:'repair',amountCents:180000,providerAccountId:'demo_crafts',classification:'owner'});
  addProviderPayment(p,{id:'pay_demo_repair_2025',year:2025,providerAccountId:'demo_crafts',amountCents:180000,date:'2025-11-15'});
  addTenantPayment(p,{id:'demo_paid_berger_2025',year:2025,tenancyId:'demo_lease_berger',amountCents:264000,date:'2025-12-15'});
  addTenantPayment(p,{id:'demo_paid_schneider_2025',year:2025,tenancyId:'demo_lease_schneider',amountCents:216000,date:'2025-12-15'});
}

function addYear2026(p){
  const costs=[
    ['demo_tax_2026','property_tax',252000,'demo_city'],
    ['demo_insurance_2026','building_insurance',126000,'demo_insurer'],
    ['demo_waste_2026','waste',75600,'demo_waste_provider'],
    ['demo_power_2026','common_electricity',50400,'demo_power_provider'],
    ['demo_water_2026','cold_water',96000,'demo_water_provider']
  ];
  for(const [id,category,amountCents,providerAccountId] of costs){
    addExpense(p,{id,year:2026,category,amountCents,providerAccountId});
    if(category==='cold_water') addWaterRule(p,{id:`rule_${id}`,expenseId:id,periodId:'demo_year_2026',withUserChange:true});
    else addAreaRule(p,{id:`rule_${id}`,expenseId:id,periodId:'demo_year_2026',withUserChange:true});
    addProviderPayment(p,{id:`pay_${id}`,year:2026,providerAccountId,amountCents,date:'2026-12-20'});
  }
  addExpense(p,{id:'demo_repair_2026',year:2026,category:'repair',amountCents:95000,providerAccountId:'demo_crafts',classification:'owner'});
  addProviderPayment(p,{id:'pay_demo_repair_2026',year:2026,providerAccountId:'demo_crafts',amountCents:95000,date:'2026-10-10'});
  addTenantPayment(p,{id:'demo_paid_berger_2026',year:2026,tenancyId:'demo_lease_berger',amountCents:264000,date:'2026-12-15'});
  addTenantPayment(p,{id:'demo_paid_schneider_2026',year:2026,tenancyId:'demo_lease_schneider',amountCents:108000,date:'2026-06-30'});
  addTenantPayment(p,{id:'demo_paid_vogel_2026',year:2026,tenancyId:'demo_lease_vogel',amountCents:120000,date:'2026-12-15'});
}
...
function addRentalDocuments(project){
  ...
  p=createRentalDocumentDraft(p,{
    ...
    fields:{tenantLabel:'Familie Berger · fiktiv',startDate:'2025-01-01',baseRentCents:98000,
  ...
  p=createRentalDocumentDraft(p,{
    ...
    tenancyId:'demo_lease_vogel',createdOn:'2026-07-01',title:'Übergabeprotokoll · Wohnung B',
    fields:{kind:'move_in',date:'2026-07-01',keys:'2 Haustürschlüssel, 2 Wohnungsschlüssel, 1 Briefkastenschlüssel',
  ...
  p=createRentalDocumentDraft(p,{
    ...
    tenancyId:'demo_lease_vogel',createdOn:'2026-07-01',title:'Mieter-Serviceblatt · Wohnung B',
    fields:{purpose:'Einzug und erste Orientierung',subject:'Willkommen im Demo-Haus Lindenblick',
      ...
      requestedInfo:'Änderungen an Kontaktdaten bitte mitteilen.',deadline:'2026-07-15'}
  }).project;
  return p;
}
...
function addLettingDemo(project){
  let p=createLettingProcess(project,{
    processId:'demo_letting_2026',propertyId:'demo_house',unitId:'demo_rent_b',
    createdOn:'2026-05-15',referenceLabel:'Sommer 2026 · Vorgang ohne Personendaten'
  }).project;
  for(const item of LETTING_ITEMS.filter(x=>x.phase==='A_VIEWING')){
    p=setLettingItemState(p,{processId:'demo_letting_2026',itemKey:item.key,state:item.key==='a_wbs_if_social'?'not_applicable':'done'}).project;
  }
  p=advanceLettingPhase(p,{processId:'demo_letting_2026',nextPhase:'B_INTEREST'}).project;
  for(const item of LETTING_ITEMS.filter(x=>x.phase==='B_INTEREST')){
    p=setLettingItemState(p,{processId:'demo_letting_2026',itemKey:item.key,state:['b_wbs_document','b_pets_if_relevant','b_insolvency_open','b_eviction_title_5y'].includes(item.key)?'not_applicable':'done'}).project;
  }
  p=advanceLettingPhase(p,{processId:'demo_letting_2026',nextPhase:'C_SELECTED'}).project;
  for(const item of LETTING_ITEMS.filter(x=>x.phase==='C_SELECTED')){
    p=setLettingItemState(p,{processId:'demo_letting_2026',itemKey:item.key,state:['c_public_payment_proof','c_rent_breach','c_prior_termination'].includes(item.key)?'not_applicable':'done'}).project;
  }
  return p;
}
...
export function buildDemoProject(){
  ...
  for(const periodId of ['demo_year_2025','demo_year_2026']){

...
export function buildLeaseDocument(input){
 ...
 s.push(S(9,c.care.smallRepairs?'Kleinreparaturen':'Instandhaltung',c.care.smallRepairs?'<p>Soweit wirksam vereinbar, trägt der Mieter kleine Reparaturen an Gegenständen seines häufigen unmittelbaren Zugriffs bis <strong>'+euro(c.care.smallRepairSingleCents)+'</strong> je Einzelfall und insgesamt bis <strong>'+euro(c.care.smallRepairAnnualCapCents)+'</strong> pro Vertragsjahr. Diese Klausel ist vor Verwendung gesondert zu prüfen.</p>':'<p>Eine gesonderte Kleinreparaturkostenübernahme wird in dieser Fassung nicht vereinbart.</p>'));
 s.push(S(10,'Schönheitsreparaturen',c.care.cosmeticRepairs?'<p>Eine Übertragung soll nur im rechtlich zulässigen Umfang erfolgen; starre Fristen oder eine zustandsunabhängige Endrenovierung werden nicht vereinbart. Die konkrete Klausel ist vor Verwendung gesondert zu prüfen.</p>':'<p>Diese Fassung enthält keine gesonderte formularmäßige Übertragung von Schönheitsreparaturen.</p>'));

...
const I18N={
 ...
 eyebrow:{de:'Baustein 6 · Sicherung & Jahreswechsel',en:'Module 6 · Backup & year change'},title:{de:'Daten sichern, Wiederherstellung vorher prüfen und das Folgejahr leer starten.',en:'Back up data, preview restores first and start the next year empty.'},copy:{de:'Die Sicherung bleibt versioniert und transparent. Ein Jahreswechsel übernimmt nur Objekt und Zeitraum – keine Beträge, Rechnungen, Zahlungen oder Messwerte.',en:'The backup remains versioned and transparent. A year change carries over only property and period – no amounts, invoices, payments or readings.'},
 pdfCenter:{de:'PDF-Zentrale',en:'PDF centre'},archive:{de:'Archiv',en:'Archive'},help:{de:'Hilfe',en:'Help'},storage:{de:'Speicher',en:'Storage'},storageCopy:{de:'Lokaler Browser-Speicher dieses Geräts.',en:'Local browser storage on this device.'},schema:{de:'Schema',en:'Schema'},

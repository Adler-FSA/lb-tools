...
const I18N={
  ...
  proTools:{de:'Vertragswerkzeuge',en:'Contract tools'},leaseWorkshopTitle:{de:'Wohnraum-Mietvertrag',en:'Residential lease'},leaseWorkshopCopy:{de:'Mietvertrag strukturiert konfigurieren, getrennten Prüfbedarf sehen und anschließend als sauberes Vertragsdokument ausgeben.',en:'Configure a structured German residential lease, keep review items separate and output a clean contract document.'},openLeaseWorkshop:{de:'Mietvertragswerkstatt öffnen',en:'Open lease workshop'},houseRulesWorkshopTitle:{de:'Hausordnung',en:'House rules'},houseRulesWorkshopCopy:{de:'Hausregeln passend zum Gebäude konfigurieren und Bewohnerinformation von Vertragsanlage unterscheiden.',en:'Configure building rules and distinguish resident information from a contract attachment.'},openHouseRulesWorkshop:{de:'Hausordnung konfigurieren',en:'Configure house rules'},

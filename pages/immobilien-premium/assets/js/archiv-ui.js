...
const I18N={
 ...
 eyebrow:{de:'Dokumentarchiv',en:'Document archive'},title:{de:'Freigegebene Fassungen bleiben unverändert nachvollziehbar.',en:'Released versions remain traceable without being altered.'},copy:{de:'Version, Snapshot und Freigabedatum gehören zusammen. Eine tatsächliche Übergabe wird als eigener Vermerk gespeichert und verändert die freigegebene Fassung nicht.',en:'Version, snapshot and release date belong together. Actual delivery is stored as a separate record and does not alter the released version.'},
 ...
 allProperties:{de:'Alle Immobilien',en:'All properties'},empty:{de:'Noch keine passende Dokumentfassung vorhanden.',en:'No matching document version yet.'},version:{de:'Version',en:'Version'},releasedOn:{de:'Freigegeben',en:'Released'},created:{de:'Erstellt',en:'Created'},review:{de:'Prüffassung',en:'Review version'},preview:{de:'Vorschau öffnen',en:'Open preview'},pdfAgain:{de:'PDF erneut erstellen',en:'Create PDF again'},deliveryTitle:{de:'Übergabe dokumentieren',en:'Record delivery'},deliveryDate:{de:'Übergabedatum',en:'Delivery date'},channel:{de:'Weg',en:'Channel'},email:{de:'E-Mail',en:'Email'},paper:{de:'Papier',en:'Paper'},portal:{de:'Portal',en:'Portal'},personal:{de:'Persönlich',en:'In person'},other:{de:'Sonstiges',en:'Other'},noteLabel:{de:'Notiz',en:'Note'},saveDelivery:{de:'Übergabe speichern',en:'Save delivery'},deliverySaved:{de:'Übergabe wurde separat dokumentiert.',en:'Delivery recorded separately.'},pdfReady:{de:'PDF wurde aus der freigegebenen Fassung neu erstellt.',en:'PDF recreated from the released version.'},deliveries:{de:'Dokumentierte Übergaben',en:'Recorded deliveries'},none:{de:'Keine',en:'None'}
};
initI18n(I18N);

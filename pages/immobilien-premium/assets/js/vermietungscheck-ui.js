...
const I18N={
 noUnits:{de:'Bitte zuerst eine Immobilie mit Einheit anlegen.',en:'Please create a property with a unit first.'},
 created:{de:'Datensparsamer Vermietungsvorgang wurde angelegt.',en:'Data-minimised letting process created.'},
 saved:{de:'Prüfstatus gespeichert.',en:'Check status saved.'},
 advanced:{de:'Vermietungsphase wurde fortgesetzt.',en:'Letting phase advanced.'},
 deleted:{de:'Vermietungsvorgang wurde vollständig gelöscht.',en:'Letting process deleted completely.'},
 open:{de:'Offen',en:'Open'},done:{de:'Erledigt',en:'Done'},na:{de:'Nicht zutreffend',en:'Not applicable'},
 next:{de:'Nächste Phase',en:'Next phase'},remove:{de:'Vorgang löschen',en:'Delete process'},newProcess:{de:'Neuen Vorgang anlegen',en:'Create new process'}
};
initI18n(I18N);

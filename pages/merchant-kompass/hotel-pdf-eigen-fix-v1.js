/* Hotel-PDF: gezielte Korrekturen nur für hotel-pdf-eigen-test.html. */
(()=>{'use strict';
...
function fix(source){
 ...
 // Kapitel bleiben bei ihrem ersten Inhalt. Regionale Vierergruppe bleibt zusammen.

...
URL = "https://www.bafin.de/DE/verbraucherinnen-verbraucher/news-warnungen/warnmeldungen/warnmeldungen_node.html"
...
for a in soup.find_all("a", href=True):
    ...
    if any(x in probe for x in ("warn", "prospekt", "unerlaub", "marktmanip", "cms_gtp", "cms_gts", "seite", "meldung")):
        print("TEXT:", text[:180])
        print("HREF:", href)
        print("---")
